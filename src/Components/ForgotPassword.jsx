...
import SolveSphereTempLogo from "../animations/SolveSphereTempLogo.json";
...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-3 lg:px-8">
      <div className="logo">
        <Lottie
          animationData={SolveSphereTempLogo}
          loop={true}
          autoplay={true}
          style={{ width: 100, paddingLeft: 0 }}
        />
        <h1 className="text-2xl font-bold opacity-70 my-auto">SolveSphere</h1>
      </div>
